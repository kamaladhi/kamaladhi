...
I build systems at the intersection of physics, machine learning, and hardware — from
physics-informed neural networks to servo-driven rescue robots.
...
**ML / AI:** PyTorch · PINNs · Federated Learning · LSTMs · Attention · YOLOv8 · LoRA / QLoRA  
**HPC:** CUDA · OpenMP · C++ · Parallel & Heterogeneous Computing  
**Full Stack:** Python · React · Flask · REST APIs · MySQL · HTML5 · CSS3  
**Hardware / IoT:** Raspberry Pi · Arduino · Blynk IoT  
**MLOps:** MLflow · Weights & Biases · Git · GitHub  
...
| [Urban Microgrid Digital Twin](https://github.com/kamaladhi/A-Predictive-Cyber-Physical-Digital-Twin-for-Urban-Microgrid-Resilience.) | Predictive cyber-physical resilience framework | Python |
